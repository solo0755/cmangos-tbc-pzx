...
bool GossipHello_TeleportNPC2(Player* player, Creature* _Creature)
{
    // HORDE
...
//bool GossipHello_Pzx_NPC(Player* player, Creature* creature)
//{
//    player->CLOSE_GOSSIP_MENU();
//    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, u8"|cFF990066|TInterface\\ICONS\\INV_Holiday_Christmas_Present_02.blp:30|t|r 传送点~~(|cffff0000必选|r)", GOSSIP_SENDER_MAIN, 101);
//    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, u8"|cFF990066|TInterface\\ICONS\\Spell_Arcane_PortalThunderBluff.blp:30|t|r 新手初始化", GOSSIP_SENDER_MAIN, 300);
//    player->ADD_GOSSIP_ITEM(GOSSIP_ICON_CHAT, u8"|cFF990066|TInterface\\ICONS\\INV_Misc_Gift_03.blp:30|t|r 新手初始化2-|cff6247c8职业套装|h|r", GOSSIP_SENDER_MAIN, 400);
//    player->SEND_GOSSIP_MENU(player->GetGossipTextId(creature), creature->GetObjectGuid());
//    return true;
//}
//bool GossipSelect_Pzx_NPC(Player* player, Creature* creature, uint32 sender, uint32 action)
//{
//    switch (action)
//    {
//    case 300:
//       return  GossipHello_PremadeGearNPC(player, creature);
//    case 400:
//        return GossipHello_PremadeSpecNPC(player, creature);
//    case 500:
//        return  GossipHello_ProfessionNPC(player, creature);
//    case 600:
//        return  GossipHello_EnchantNPC(player, creature);
//    default:
//        break;
//        player->CLOSE_GOSSIP_MENU();
//    }
