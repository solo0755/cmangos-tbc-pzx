...
void ObjectMgr::LoadPlayerPremadeTemplates()//pzx init
{
    {
...
void ObjectMgr::ApplyPremadeGearTemplateToPlayer(uint32 entry, Player* pPlayer) const //pzx init
{
    auto itr = m_playerPremadeGearMap.find(entry);
    if (itr == m_playerPremadeGearMap.end())
    {
...
void ObjectMgr::ApplyPremadeSpecTemplateToPlayer(uint32 entry, Player* pPlayer) const //pzx init
{
    auto itr = m_playerPremadeSpecMap.find(entry);
    if (itr == m_playerPremadeSpecMap.end())
    {
